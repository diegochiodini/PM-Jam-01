/*	DebugStreamer in c#
	...
	Â· to use, add this script to a game object, then from another script simply add "DebugStreamer.messages.Add("text to display");
...
public class DebugStreamer : MonoBehaviour {
	...
	void Update () {
		...
		for(int messageIndex = 0; messageIndex < messages.Count; messageIndex++)
		{
            ...
            //Format.FormatGuiTextArea(guiTxt, (float)Screen.width);
		}
		messages.Clear();
